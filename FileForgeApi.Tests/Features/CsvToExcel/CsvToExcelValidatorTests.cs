...
public class CsvToExcelValidatorTests
{
    [Fact]
    public void Validate_NullRequest_ReturnsFailure()
    {
        var result = CsvToExcelValidator.Validate(null);
    ...
    public void Validate_EmptyBase64_ReturnsFailure()
    {
        ...
        var result = CsvToExcelValidator.Validate(request);
    ...
    {
        var request = new CsvToExcelRequest("not-valid-base64!!!");
    ...
    {
        var emptyBase64Request = new CsvToExcelRequest(Convert.ToBase64String(Array.Empty<byte>()));
        var result = CsvToExcelValidator.Validate(emptyBase64Request);
        Assert.False(result.IsSuccess);
    }
    ...
    public void Validate_ValidBase64_ReturnsSuccessWithBytes()
    {
        ...
        var request = new CsvToExcelRequest(Convert.ToBase64String(bytes));
    ...
    {
        var request = new CsvToExcelRequest(Convert.ToBase64String(new byte[] { 1 }), Separator: ";;");
    ...
    {
        var request = new CsvToExcelRequest(Convert.ToBase64String(new byte[] { 1 }), Encoding: "invalid-encoding");
    ...
    {
        var request = new CsvToExcelRequest(Convert.ToBase64String(new byte[] { 1 }), DocumentUrl: "https://example.com/f.csv");
    ...
    {
        var request = new CsvToExcelRequest(null, DocumentUrl: "not-a-url");
